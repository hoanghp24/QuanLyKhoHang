...
public class ChiTietSanPhamDAO implements DAOinterface<ChiTietSanPhamDTO> {
    ...
    public int insert(ChiTietSanPhamDTO t) {
        ...
        try {
            ...
            String sql = "INSERT INTO `ctsanpham`(`maisbn`, `maphienbansp`, `maphieunhap`, `tinhtrang`) VALUES (?,?,?,?)";
    ...
    public int update(ChiTietSanPhamDTO t) {
        ...
        try {
            Connection con = (Connection) JDBCUtil.getConnection();
            String sql = "UPDATE `ctsanpham` SET `maphienbansp`=?,`maphieunhap`=?,`maphieuxuat`=?,`tinhtrang`=? WHERE `maisbn`=?";
            PreparedStatement pst = (PreparedStatement) con.prepareStatement(sql);
    ...
    public int updateXuat(ChiTietSanPhamDTO t) {
        ...
        try {
            Connection con = (Connection) JDBCUtil.getConnection();
            String sql = "UPDATE `ctsanpham` SET `maphieuxuat`=?,`tinhtrang`=? WHERE `maisbn`=?";
            PreparedStatement pst = (PreparedStatement) con.prepareStatement(sql);
            pst.setInt(1, t.getMaphieuxuat());
            pst.setInt(2, t.getTinhtrang());
            pst.setString(3, t.getIsbn());
            result = pst.executeUpdate();
            JDBCUtil.closeConnection(con);
        } catch (SQLException ex) {
            Logger.getLogger(ChiTietSanPhamDAO.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public int reset(ChiTietSanPhamDTO t) {
        ...
        try {
            Connection con = (Connection) JDBCUtil.getConnection();
            String sql = "UPDATE `ctsanpham` SET `maphieuxuat`= NULL ,`tinhtrang`='1' WHERE `maisbn`=?";
            PreparedStatement pst = (PreparedStatement) con.prepareStatement(sql);
            pst.setString(1, t.getIsbn());
            result = pst.executeUpdate();
            JDBCUtil.closeConnection(con);
    ...
    public int delete(String t) {
        ...
        try {
            Connection con = (Connection) JDBCUtil.getConnection();
            String sql = "UPDATE `ctsanpham` SET `tinhtrang` = 0 WHERE  maisbn = ?";
            PreparedStatement pst = (PreparedStatement) con.prepareStatement(sql);
            result = pst.executeUpdate();
            JDBCUtil.closeConnection(con);
        } catch (SQLException ex) {
    ...
    public ArrayList<ChiTietSanPhamDTO> selectAll() {
        ...
        try {
            ...
            while (rs.next()) {
                String isbn = rs.getString("maisbn");
                int macauhinh = rs.getInt("phienbansp");
                int maphieunhap = rs.getInt("maphieunhap");
                int maphieuxuat = rs.getInt("maphieuxuat");
                int tinhtrang = rs.getInt("tinhtrang");
                ChiTietSanPhamDTO ct = new ChiTietSanPhamDTO(isbn, macauhinh, maphieunhap, maphieuxuat, tinhtrang);
                result.add(ct);
            }
            JDBCUtil.closeConnection(con);
        } catch (Exception e) {
    ...
    public ArrayList<ChiTietSanPhamDTO> selectAllbyPb(int mapbsp) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                int maphieuxuat = rs.getInt("maphieuxuat");
                int tinhtrang = rs.getInt("tinhtrang");
                ChiTietSanPhamDTO ct = new ChiTietSanPhamDTO(isbn, maphienban, maphieunhap, maphieuxuat, tinhtrang);
                result.add(ct);
            }
            JDBCUtil.closeConnection(con);
        } catch (Exception e) {
    ...
    public ArrayList<ChiTietSanPhamDTO> selectAllByMaPhieuNhap(int maphieunhap) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                int maphieuxuat = rs.getInt("maphieuxuat");
                int tinhtrang = rs.getInt("tinhtrang");
                ChiTietSanPhamDTO ct = new ChiTietSanPhamDTO(isbn, maphienban, mapn, maphieuxuat, tinhtrang);
                result.add(ct);
            }
            JDBCUtil.closeConnection(con);
        } catch (SQLException e) {
