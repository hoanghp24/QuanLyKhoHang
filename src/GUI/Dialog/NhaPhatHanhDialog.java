...
public class NhaPhatHanhDialog extends JDialog implements ActionListener {

    private NhaPhatHanh jpNph;
    private HeaderTitle titlePage;
    private JPanel pnmain, pnbottom;
    private ButtonCustom btnThem, btnCapNhat, btnHuyBo;
    private InputForm tenNph;
    private InputForm diachi;
    private InputForm email;
    private InputForm sodienthoai;
    private NhaPhatHanhDTO nphDTO;

    public NhaPhatHanhDialog(NhaPhatHanh jpNph, JFrame owner, String title, boolean modal, String type) {
        super(owner, title, modal);
        this.jpNph = jpNph;
        initComponents(title, type);
    }

    public NhaPhatHanhDialog(NhaPhatHanh jpNph, JFrame owner, String title, boolean modal, String type, NhaPhatHanhDTO nphdto) {
        super(owner, title, modal);
        this.jpNph = jpNph;
        this.nphDTO = nphdto;
        initComponents(title, type);
    ...
    public void initInfo() {
        tenNph.setText(nphDTO.getTennph());
        diachi.setText(nphDTO.getDiachi());
        email.setText(nphDTO.getEmail());
        sodienthoai.setText(nphDTO.getSdt());
    }

    public void initView() {
        tenNph.setEditable(false);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == btnThem && Validation()) {
            int manph = NhaPhatHanhDAO.getInstance().getAutoIncrement();  
            jpNph.nphBUS.add(new NhaPhatHanhDTO(manph, tenNph.getText(), diachi.getText(), email.getText(), sodienthoai.getText()));
            ...
            jpNph.nphBUS.update(new NhaPhatHanhDTO(nphDTO.getManph(), tenNph.getText(), diachi.getText(), email.getText(), sodienthoai.getText()));
            jpNph.loadDataTable(jpNph.listnph);
            dispose();
        }
    }
