...
public class ListKhachHangDialog extends JDialog implements MouseListener {
    ...
    public ListKhachHangDialog(ListKhachHang jpKH, String title, boolean modal, String type) {
        super(jpKH, title, modal);
        this.jpKH = jpKH;
    ...
    public ListKhachHangDialog(ListKhachHang jpKH, String title, boolean modal, String type, DTO.KhachHangDTO kh) {
        super(jpKH, title, modal);
        this.kh=kh;
        maKH = new JTextField("");
