...
public class Log_In extends JFrame implements KeyListener {
    ...
    private void initComponent() {
        ...
        this.setTitle("Đăng nhập - Hệ Thống Quản Lý Sách");
        ...
        pnlLogIn.setBackground(new Color(16,124,237));
        ...
        lbl7.setFont(new Font(FlatRobotoFont.FAMILY, Font.PLAIN, 14));
    ...
    private void pnlLogInMouseEntered(java.awt.event.MouseEvent evt) {
        pnlLogIn.setBackground(new Color(170,203,255));
    ...
    public void imgIntro() {
        ...
        lblImage = new JLabel();
        lblImage.setIcon(new FlatSVGIcon("./icon/login.svg"));
        bo.add(lblImage);
    }
