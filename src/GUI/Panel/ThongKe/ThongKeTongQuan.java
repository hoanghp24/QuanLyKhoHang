...
public class ThongKeTongQuan extends JPanel {
    ...
    String[][] getSt = {
        {"Sản phẩm trong kho", "productt.svg", Integer.toString(SanPhamDAO.getInstance().selectAll().size())},
        {"Khách hàng ", "stafff.svg", Integer.toString(KhachHangDAO.getInstance().selectAll().size())},
