    ...
    private void tblTonKhoClicked(java.awt.event.MouseEvent evt) {
        ...
        if (evt.getClickCount() == 2) {
            if (tblTonKho.getSelectedRow() == -1) {
                ...
                ThongKePBSPTonKho sppp = new ThongKePBSPTonKho((JFrame) javax.swing.SwingUtilities.getWindowAncestor(this), "Chi tiết tồn kho từng phiên bản", true, listSp.get(masp));
            }
        }
    }
