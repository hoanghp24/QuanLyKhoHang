...
public class ThongKeNhaPhatHanh extends JPanel implements ActionListener, KeyListener, PropertyChangeListener {
    ...
    ArrayList<ThongKeNhaPhatHanhDTO> list;
    ...
    public void initComponent() {
        ...
        tenkhachhang = new InputForm("Tìm kiếm nhà phát hành");
        ...
        String[] header = new String[]{"STT", "Mã nhà phát hành", "Tên nhà phát hành", "Số lượng nhập", "Tổng số tiền"};
    ...
    public void loadDataTable(ArrayList<ThongKeNhaPhatHanhDTO> result) {
        tblModel.setRowCount(0);
        int k = 1;
        for (ThongKeNhaPhatHanhDTO i : result) {
            tblModel.addRow(new Object[]{
                k, i.getManph(), i.getTennph(), i.getSoluong(), Formater.FormatVND(i.getTongtien())
            });
            k++;
        }
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (source == export) {
            try {
                ...
                Logger.getLogger(ThongKeNhaPhatHanh.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public void keyReleased(KeyEvent e) {
        try {
            ...
            java.util.logging.Logger.getLogger(ThongKeNhaPhatHanh.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
    }
