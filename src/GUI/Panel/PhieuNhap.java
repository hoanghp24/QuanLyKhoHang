...
public final class PhieuNhap extends JPanel implements ActionListener, KeyListener, PropertyChangeListener, ItemListener {
    ...
    SelectForm cbxNhaphathanh, cbxNhanVien;
    ...
    private void initComponent() {
        ...
        search = new IntegratedSearch(new String[]{"Tất cả", "Mã phiếu", "Nhà phát hành", "Nhân viên nhập"});
    ...
    public void leftFunc() {
        ...
        // Handel
        String[] listKh = nhaPhatHanhBUS.getArrTenNhaPhatHanh();
        ...
        // init
        cbxNhaphathanh = new SelectForm("Nhà phát hành", listKh);
        ...
        // add listener
        cbxNhaphathanh.getCbb().addItemListener(this);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (source == mainFunction.btn.get("create")) {
            taoPhieuNhap = new TaoPhieuNhap(m, tk, "create");
            m.setPanel(taoPhieuNhap);
    ...
    public void loadDataTalbe(ArrayList<PhieuNhapDTO> listphieuNhap) {
        ...
        for (int i = 0; i < size; i++) {
            tblModel.addRow(new Object[]{
                ...
                nhaPhatHanhBUS.getTenNhaPhatHanh(listphieuNhap.get(i).getManhaphathanh()),
    ...
    public int getRow() {
        return tablePhieuNhap.getSelectedRow();
    }

    public void Fillter() throws ParseException {
        if (validateSelectDate()) {
            int type = search.cbxChoose.getSelectedIndex();
            int manph = cbxNhaphathanh.getSelectedIndex() == 0 ? 0 : nhaPhatHanhBUS.getByIndex(cbxNhaphathanh.getSelectedIndex() - 1).getManph();
    ...
    public void resetForm() {
        cbxNhaphathanh.setSelectedIndex(0);
