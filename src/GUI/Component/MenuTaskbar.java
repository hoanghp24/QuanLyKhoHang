...
public class MenuTaskbar extends JPanel {
    ...
    String[][] getSt = {
        ...
        {"Tổng quan", "home.svg", "thongke"},
        {"Sản phẩm", "product.svg", "sanpham"},
        // {"Thuộc tính", "brand.svg", "thuoctinh"},
        {"Chi nhánh", "area.svg", "khuvuckho"},
        {"Nhập hàng", "import.svg", "nhaphang"},
        {"Đơn hàng", "export.svg", "xuathang"},
        {"Khách hàng", "customer.svg", "khachhang"},
        {"Nhà phát hành", "supplier.svg", "nhaphathanh"},
...
//        });
        ...
        listitem[3].addMouseListener(new MouseAdapter() {
            @Override
            public void mousePressed(MouseEvent evt) {
                phieuNhap = new PhieuNhap(main, user);
        ...
        listitem[6].addMouseListener(new MouseAdapter() {
            @Override
            public void mousePressed(MouseEvent evt) {
                nhaPhatHanh = new NhaPhatHanh(main);
                main.setPanel(nhaPhatHanh);
            }
        });
