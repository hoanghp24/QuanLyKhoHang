...
public class writePDF {
    ...
    public void writePN(int maphieu) {
        ...
        try {
            ...
            url = getFile("phieu_nhap_" + maphieu);
            ...
            Paragraph company = new Paragraph("Hệ thống quản lý sách Đông Triều", fontBold15);
            ...
            String ncc = NhaPhatHanhDAO.getInstance().selectById(pn.getManhaphathanh() + "").getTennph();
            Paragraph paragraph2 = new Paragraph("Nhà phát hành: " + ncc, fontNormal10);
            paragraph2.add(new Chunk(createWhiteSpace(5)));
            paragraph2.add(new Chunk("-"));
            paragraph2.add(new Chunk(createWhiteSpace(5)));
            String sdt = NhaPhatHanhDAO.getInstance().selectById(pn.getManhaphathanh() + "").getSdt();
            paragraph2.add(new Chunk(sdt, fontNormal10));
            ...
            for (ChiTietPhieuDTO ctp : ChiTietPhieuNhapDAO.getInstance().selectAll(maphieu + "")) {
                ...
                table.addCell(new PdfPCell(new Phrase(ngonNguBUS.getNgonNguById(pbsp.getNgonngu()) + " - "
                        + loaiBiaBUS.getLoaiBiaById(pbsp.getLoaibia()) + " - " + pbsp.getSotrang(), fontNormal10)));
            ...
            paragraph.add(new Chunk(createWhiteSpace(30)));
            paragraph.add(new Chunk("Nhà phát hành", fontBoldItalic15));
    ...
    public void writePX(int maphieu) {
        ...
        try {
            ...
            // Thêm tên công ty vào file PDF
            document.add(Chunk.NEWLINE);
            Paragraph header = new Paragraph("THÔNG TIN HOÁ ĐƠN", fontBold25);
            header.setAlignment(Element.ALIGN_CENTER);
            document.add(header);
            ...
            paragraph2.add(new Chunk("-"));
            paragraph2.add(new Chunk(createWhiteSpace(5)));
            String sdt = KhachHangDAO.getInstance().selectById(px.getMakh() + "").getSdt();
            paragraph2.add(new Chunk(sdt, fontNormal10));
